...
from desktop.config.config_env import NAME_FOLDER
from desktop.controls.display.progress_bar import progress_control
from desktop.controls.display.progress_bar import update_progress
...
def window_event(e) -> None:
    ...
    from desktop.controls.display.confirm_dialog import confirm_dialog
...
def on_key_enter_event(e) -> None:
    ...
    from desktop.controls.buttons.elevated_button import generate_button
