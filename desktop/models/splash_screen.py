...
from desktop.config.config_env import PATH_LOGO
from desktop.models.enums.enums import EffectType
from desktop.models.alert_snackbar import AlertSnackbar

# Importações dos módulos locais
from desktop.controls.buttons.elevated_button import (
    generate_button,
    cancel_button,
    exit_button,
    open_folder_button
)
from desktop.controls.inputs.checkboxs import (
    checkbox_excel_field,
    checkbox_pdf_field
)
from desktop.controls.inputs.input_text import (
    cpf_field,
    unit_field,
    list_results,
    start_date_field,
