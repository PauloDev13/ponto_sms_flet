...
from desktop.controls.inputs.checkboxs import checkbox_pdf_field, checkbox_excel_field
from desktop.controls.inputs.input_text import cpf_field, start_date_field, end_date_field
from desktop.controls.inputs.input_text import unit_field
from desktop.services.data.init_generate_service import init_generate_files
from desktop.utils.share_model import button_style, close_app, clear_form, open_folder
